...
import { Flag, ArrowLeft, CheckCircle, XCircle, FileEdit, Save } from 'lucide-react';
        ...
        <div className="flex">
            ...
            <div className="p-4 border-t border-indigo-100">
              {!isEditing ? (
                <button
                  ...
                  className="w-full inline-flex items-center justify-center px-6 py-3 bg-gradient-to-r from-blue-600 to-indigo-600 text-white hover:from-blue-700 hover:to-indigo-700 rounded-lg transition-all duration-200 font-medium shadow-sm"
                >
                ...
                <button
                  ...
                  className="w-full inline-flex items-center justify-center px-6 py-3 bg-gradient-to-r from-green-600 to-emerald-600 text-white hover:from-green-700 hover:to-emerald-700 rounded-lg transition-all duration-200 font-medium shadow-sm"
                >
          ...
          <div className="w-1/2 p-8">
            ...
            <div className="mt-8 space-y-4">
              {certificate.status === 'Flagged' && !isEditing && (
                <div className="flex items-center space-x-4">
                  <button
                    onClick={handleAccept}
                    className="flex-1 inline-flex items-center justify-center px-6 py-3 border border-green-500 text-green-500 hover:bg-green-50 rounded-lg transition-colors duration-200 font-medium"
                  >
                  ...
                  <button
                    ...
                    className="flex-1 inline-flex items-center justify-center px-6 py-3 border border-red-500 text-red-500 hover:bg-red-50 rounded-lg transition-colors duration-200 font-medium"
                  >
              ...
              {!isEditing && (
                <button
                  ...
                  className="w-full inline-flex items-center justify-center px-6 py-3 border border-red-500 text-red-500 hover:bg-red-50 rounded-lg transition-colors duration-200 font-medium"
                >
...
export default StaffCertificatePreview;
