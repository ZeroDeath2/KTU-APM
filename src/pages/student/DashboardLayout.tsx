...
const DashboardLayout: React.FC<DashboardLayoutProps> = ({ children }) => {
  ...
  const menuItems = [
    { icon: LayoutDashboard, text: 'Dashboard', href: '/student/dashboard' },
    { icon: Upload, text: 'Upload Certificates', href: '/student/upload' },
    { icon: FileText, text: 'View Certificates', href: '/student/certificates' },
  ];
